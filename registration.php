        ...
        <form action="insertUser.php" method="post">
            <div class="container_reg">
                ...
                <div >
                    ...
                    <p><input type="checkbox" id="toggle" /> By creating an account you agree to our   <a href="#" data-toggle="popover" title="Popover Header" data-content="We care about the privacy of our Users. You understand that by using the Services you consent to the collection, use and disclosure of your personally identifiable information and aggregate data as set forth in our Privacy Policy and to have your personal information collected, used, transferred to and processed in the United States.">Terms & Privacy</a>.</p>
                                       <div class="clearfix">
