    ...
    <div class="wrapper_content" id="texter">
       ...
       <div id="matter_get"><!--IMPORTANT DIV HELPS TO RELOAD-->
           ...
           <div class="uploader" style="clear: both;width: 100%;">
                   ...
                   <div class="container" style="float: left;width: 40%;border-left:2px solid #cccccc;background: rgba(25, 25, 25, .7);">
              ...
              <div style="float: right;width: 50%;background: rgba(25, 25, 25, .7);"><p id="showthis"><?php echo $_SESSION['check']?></p></div>
