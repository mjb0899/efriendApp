    ...
    <div class="wrapper_content" id="texter">
       ...
       <div id="matter_get"><!--IMPORTANT DIV HELPS TO RELOAD-->
           ...
           <div class="uploader" style="clear: both;width: 100%;">
                   ...
                   <div class="container" style="float: left;width: 40%;border-left:2px solid #cccccc;background: whitesmoke"">
              ...
              <div style="float: right;width: 50%;border-right:2px solid #cccccc;background: whitesmoke"><p id="showthis"><?php echo $_SESSION['check']?></p></div>
